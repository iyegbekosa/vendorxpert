...
def test_welcome_emails():
    ...
    try:
        ...
        if result:
            print(f"✅ Customer welcome email sent successfully to {TEST_EMAIL_RECIPIENT}")
        else:
    ...
    try:
        ...
        if result:
            print(f"✅ Vendor welcome email sent successfully to {TEST_EMAIL_RECIPIENT}")
        else:
...
def test_transaction_emails():
    ...
    try:
        ...
        if result:
            print(f"✅ Vendor notification email sent successfully to {TEST_EMAIL_RECIPIENT}")
        else:
...
def run_all_tests():
    ...
    try:
        ...
        print(f"   📬 Expected emails: Welcome (customer), Welcome (vendor), Receipt, Vendor notification")
