...
class VendorPlan(models.Model):
    ...
    max_products = models.IntegerField(null=True, blank=True, help_text="Max number of products allowed")
    paystack_plan_code = models.CharField(max_length=100, blank=True, help_text="Paystack plan code if integrated")
    is_active = models.BooleanField(default=True)
